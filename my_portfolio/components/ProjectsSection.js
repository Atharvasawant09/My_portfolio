...
const projects = [
  {
    ...
    imageSrc: './port1.png', // Add your image path here
  },
  {
    name: 'CodeDrop',
    ...
    imageSrc: './port2.png', // Add your image path here
  },
  {
    name: 'Predator - Venomspree',
...
const ProjectsSection = () => {
  return (
    <div className="p-8">
      <h1 className="text-4xl text-white text-center font-bold mb-8 p-10">My Projects</h1>
